...
VALUES ('034de6ea-9e75-4cd4-ba9f-e7eeda50b2df'::uuid, 'multi', 'Tại sao người dùng biết hệ điều hành và phiên bản của hệ điều hành rất quan trọng? (chọn 2)', NULL, 1)
...
BEGIN
INSERT INTO questions (exam_id, question_type, content, image_url, order_index)
VALUES ('034de6ea-9e75-4cd4-ba9f-e7eeda50b2df'::uuid, 'dragdrop', 'Hãy sắp xếp các bước sử dụng Start Menu để gỡ cài đặt Outlook trên PC:', NULL, 2)
RETURNING id INTO qid;
...
BEGIN
INSERT INTO questions (exam_id, question_type, content, image_url, order_index)
VALUES ('034de6ea-9e75-4cd4-ba9f-e7eeda50b2df'::uuid, 'choice', 'Hãy chọn từ thích hợp để hoàn thành phát biểu sau đây: "Số kiểu máy tính (computer model number) là một số được cá nhân hóa do nhà sản xuất . . . . của nó cấp cho một máy tính”.', NULL, 3)
RETURNING id INTO qid;
...
BEGIN
INSERT INTO questions (exam_id, question_type, content, image_url, order_index)
VALUES ('034de6ea-9e75-4cd4-ba9f-e7eeda50b2df'::uuid, 'choice', 'Bạn cần tìm các trình điều khiển (driver) cho máy tính xách tay chạy Windows 10. Trình quản lý thiết bị hiển thị "thiết bị không xác định" đối với một vài thành phần thiết bị. Bạn nên làm gì?', NULL, 4)
RETURNING id INTO qid;
...
BEGIN
INSERT INTO questions (exam_id, question_type, content, image_url, order_index)
VALUES ('034de6ea-9e75-4cd4-ba9f-e7eeda50b2df'::uuid, 'choice', 'Để một ứng dụng hoạt động, phần cứng và phần mềm của máy tính phải có chung điểm gì?', NULL, 5)
RETURNING id INTO qid;
...
BEGIN
INSERT INTO questions (exam_id, question_type, content, image_url, order_index)
VALUES ('034de6ea-9e75-4cd4-ba9f-e7eeda50b2df'::uuid, 'dragdrop', 'Hãy sắp xếp các bước sử dụng Menu Apple để kiểm tra các bản cập nhật trên máy Mac:', NULL, 6)
RETURNING id INTO qid;
...
BEGIN
INSERT INTO questions (exam_id, question_type, content, image_url, order_index)
VALUES ('034de6ea-9e75-4cd4-ba9f-e7eeda50b2df'::uuid, 'dragdrop', 'Bạn đăng một Video lên trang Web của công ty. Người dùng than phiền rằng Video tải quá lâu. Bạn cần giảm thời gian tải Video. Đối với mỗi hành động, hãy chọn Có nếu hành động đó giúp tải Video nhanh hơn. Ngược lại, hãy chọn Không.', NULL, 7)
RETURNING id INTO qid;
...
BEGIN
INSERT INTO questions (exam_id, question_type, content, image_url, order_index)
VALUES ('034de6ea-9e75-4cd4-ba9f-e7eeda50b2df'::uuid, 'choice', 'Bạn hãy cho biết, tác dụng của việc tăng độ phân giải hình ảnh trước khi chụp ảnh?', NULL, 8)
RETURNING id INTO qid;
...
BEGIN
INSERT INTO questions (exam_id, question_type, content, image_url, order_index)
VALUES ('034de6ea-9e75-4cd4-ba9f-e7eeda50b2df'::uuid, 'multi', 'Người dùng nhấn nút nguồn nhưng máy tính không khởi động. Người dùng có thể thực hiện hành động nào sau đây để khắc phục sự cố? (chọn 3)', NULL, 9)
RETURNING id INTO qid;
...
BEGIN
INSERT INTO questions (exam_id, question_type, content, image_url, order_index)
VALUES ('034de6ea-9e75-4cd4-ba9f-e7eeda50b2df'::uuid, 'choice', 'Phần mềm giao tiếp và cung cấp _______ cho phần cứng.', NULL, 10)
RETURNING id INTO qid;
...
BEGIN
INSERT INTO questions (exam_id, question_type, content, image_url, order_index)
VALUES ('034de6ea-9e75-4cd4-ba9f-e7eeda50b2df'::uuid, 'choice', 'Chương trình nào sau đây có thể được sử dụng để đóng một ứng dụng đang bị đóng băng?', NULL, 11)
RETURNING id INTO qid;
...
BEGIN
INSERT INTO questions (exam_id, question_type, content, image_url, order_index)
VALUES ('034de6ea-9e75-4cd4-ba9f-e7eeda50b2df'::uuid, 'dragdrop', 'Xác định xem các thiết bị kỹ thuật số có đáp ứng các yêu cầu hay không. Chọn Đúng nếu thiết bị đáp ứng các yêu cầu hoặc chọn Sai nếu không đáp ứng.', NULL, 12)
RETURNING id INTO qid;
...
BEGIN
INSERT INTO questions (exam_id, question_type, content, image_url, order_index)
VALUES ('034de6ea-9e75-4cd4-ba9f-e7eeda50b2df'::uuid, 'choice', '. . . . .  liên quan đến máy móc được lập trình để suy nghĩ và thực hiện các hành động như con người.', NULL, 13)
RETURNING id INTO qid;
...
BEGIN
INSERT INTO questions (exam_id, question_type, content, image_url, order_index)
VALUES ('034de6ea-9e75-4cd4-ba9f-e7eeda50b2df'::uuid, 'choice', 'Tùy chọn nào sau đây là hành động giúp xóa dữ liệu cá nhân khỏi thiết bị?', NULL, 14)
RETURNING id INTO qid;
...
BEGIN
INSERT INTO questions (exam_id, question_type, content, image_url, order_index)
VALUES ('034de6ea-9e75-4cd4-ba9f-e7eeda50b2df'::uuid, 'choice', 'Loại phần mềm nào sau đây không được cấp phép, không được bảo vệ bản quyền?', NULL, 15)
RETURNING id INTO qid;
...
BEGIN
INSERT INTO questions (exam_id, question_type, content, image_url, order_index)
VALUES ('034de6ea-9e75-4cd4-ba9f-e7eeda50b2df'::uuid, 'choice', 'Tùy chọn nào sau đây được chỉ định cho mỗi phiên bản (version) phần mềm?', NULL, 16)
RETURNING id INTO qid;
...
BEGIN
INSERT INTO questions (exam_id, question_type, content, image_url, order_index)
VALUES ('034de6ea-9e75-4cd4-ba9f-e7eeda50b2df'::uuid, 'multi', 'Trung tâm dữ liệu điện toán đám mây tác động tiêu cực đến môi trường theo cách nào sau đây? (Chọn 2)', NULL, 17)
RETURNING id INTO qid;
...
BEGIN
INSERT INTO questions (exam_id, question_type, content, image_url, order_index)
VALUES ('034de6ea-9e75-4cd4-ba9f-e7eeda50b2df'::uuid, 'choice', 'Loại phần mềm nào không cho phép chia sẻ hoặc sửa đổi mã nguồn?', NULL, 18)
RETURNING id INTO qid;
...
BEGIN
INSERT INTO questions (exam_id, question_type, content, image_url, order_index)
VALUES ('034de6ea-9e75-4cd4-ba9f-e7eeda50b2df'::uuid, 'dragdrop', 'Với từng phát biểu về công nghệ tự động hoá, hãy chọn Đúng hoặc Sai.', NULL, 19)
RETURNING id INTO qid;
...
BEGIN
INSERT INTO questions (exam_id, question_type, content, image_url, order_index)
VALUES ('034de6ea-9e75-4cd4-ba9f-e7eeda50b2df'::uuid, 'multi', 'Những phím tắt nào được sử dụng phổ biến trên các ứng dụng phần mềm? (Chọn 2)', NULL, 20)
RETURNING id INTO qid;
...
BEGIN
INSERT INTO questions (exam_id, question_type, content, image_url, order_index)
VALUES ('034de6ea-9e75-4cd4-ba9f-e7eeda50b2df'::uuid, 'choice', 'Ngày nay, các thiết bị có thể trở nên lỗi thời rất nhanh. Người dùng nên làm gì với thiết bị mà họ muốn loại bỏ?', NULL, 21)
RETURNING id INTO qid;
...
BEGIN
INSERT INTO questions (exam_id, question_type, content, image_url, order_index)
VALUES ('034de6ea-9e75-4cd4-ba9f-e7eeda50b2df'::uuid, 'choice', 'Định dạng tập tin Video phổ biến nhất được sử dụng để đăng lên mạng xã hội là gì?', NULL, 22)
RETURNING id INTO qid;
...
BEGIN
INSERT INTO questions (exam_id, question_type, content, image_url, order_index)
VALUES ('034de6ea-9e75-4cd4-ba9f-e7eeda50b2df'::uuid, 'multi', 'Tùy chọn nào sau đây là đúng với tập tin có độ phân giải cao so với tập tin có độ phân giải thấp? (chọn 3)', NULL, 23)
RETURNING id INTO qid;
...
BEGIN
INSERT INTO questions (exam_id, question_type, content, image_url, order_index)
VALUES ('034de6ea-9e75-4cd4-ba9f-e7eeda50b2df'::uuid, 'choice', 'Bạn có thể sử dụng tổ hợp phím nào sau đây để lưu tài liệu?', NULL, 24)
RETURNING id INTO qid;
...
BEGIN
INSERT INTO questions (exam_id, question_type, content, image_url, order_index)
VALUES ('034de6ea-9e75-4cd4-ba9f-e7eeda50b2df'::uuid, 'multi', 'Loại tập tin WAV thường được sử dụng cho những loại phương tiện nào? (chọn 3)', NULL, 25)
RETURNING id INTO qid;
...
BEGIN
INSERT INTO questions (exam_id, question_type, content, image_url, order_index)
VALUES ('034de6ea-9e75-4cd4-ba9f-e7eeda50b2df'::uuid, 'choice', 'Phát biểu sau đây là Đúng hay Sai: "Một lợi ích của lập phiên bản đám mây là người dùng có thể lưu trữ nhiều phiên bản của một tập tin”.', NULL, 26)
RETURNING id INTO qid;
...
BEGIN
INSERT INTO questions (exam_id, question_type, content, image_url, order_index)
VALUES ('034de6ea-9e75-4cd4-ba9f-e7eeda50b2df'::uuid, 'choice', 'Bạn hãy cho biết, phát biểu sau đây là Đúng hay Sai: "Các thiết bị cũ có thể phát nội dung HD tốt tương tự như các thiết bị mới hơn, vì vậy bạn nên luôn xuất ra định dạng 1080p là một ý tưởng tốt”.', NULL, 27)
RETURNING id INTO qid;
...
BEGIN
INSERT INTO questions (exam_id, question_type, content, image_url, order_index)
VALUES ('034de6ea-9e75-4cd4-ba9f-e7eeda50b2df'::uuid, 'choice', 'Hãy cho biết, phát biểu sau đây là Đúng hay Sai: "Người dùng có thể làm bất cứ điều gì mà họ muốn sau khi họ đã cài đặt phần mềm của mình. Họ không bắt buộc phải đọc giấy phép phần mềm”.', NULL, 28)
RETURNING id INTO qid;
...
BEGIN
INSERT INTO questions (exam_id, question_type, content, image_url, order_index)
VALUES ('034de6ea-9e75-4cd4-ba9f-e7eeda50b2df'::uuid, 'choice', 'Bạn cần tìm ra phiên bản Windows mà máy tính của bạn đang chạy. Bạn nên thực hiện hành động này ở khu vực nào của cửa sổ Cài đặt (setting)?', NULL, 29)
RETURNING id INTO qid;
...
BEGIN
INSERT INTO questions (exam_id, question_type, content, image_url, order_index)
VALUES ('034de6ea-9e75-4cd4-ba9f-e7eeda50b2df'::uuid, 'multi', 'Các chuyên gia lo ngại rằng xã hội sẽ mất đi một số kỹ năng do sự phụ thuộc vào công nghệ. Tùy chọn nào sau đây là kỹ năng có thể ít được vận dụng do sử dụng công nghệ? (chọn 3)', NULL, 30)
RETURNING id INTO qid;
...
BEGIN
INSERT INTO questions (exam_id, question_type, content, image_url, order_index)
VALUES ('034de6ea-9e75-4cd4-ba9f-e7eeda50b2df'::uuid, 'choice', 'Bạn lên kế hoạch bán máy tính của mình. Bạn xoá các tập tin cá nhân trên ổ cứng và sau đó, bạn dọn sạch thùng rác của máy tính (Recycle Bin hoặc Trash). Trên ổ cứng của bạn còn lại dữ liệu nào?', NULL, 31)
RETURNING id INTO qid;
...
BEGIN
INSERT INTO questions (exam_id, question_type, content, image_url, order_index)
VALUES ('034de6ea-9e75-4cd4-ba9f-e7eeda50b2df'::uuid, 'multi', 'Tùy chọn nào sau đây là ví dụ về AI? (Chọn 2)', NULL, 32)
RETURNING id INTO qid;
...
BEGIN
INSERT INTO questions (exam_id, question_type, content, image_url, order_index)
VALUES ('034de6ea-9e75-4cd4-ba9f-e7eeda50b2df'::uuid, 'choice', 'Điều gì sẽ xảy ra khi bạn phóng to một hình ảnh Bitmap nhỏ được tải xuống từ trang Web?', NULL, 34)
RETURNING id INTO qid;
...
BEGIN
INSERT INTO questions (exam_id, question_type, content, image_url, order_index)
VALUES ('034de6ea-9e75-4cd4-ba9f-e7eeda50b2df'::uuid, 'multi', 'Loại dữ liệu nào sau đây sẽ bị xóa khi thiết bị di động Android được khôi phục cài đặt gốc? (chọn 3)', NULL, 36)
RETURNING id INTO qid;
...
BEGIN
INSERT INTO questions (exam_id, question_type, content, image_url, order_index)
VALUES ('034de6ea-9e75-4cd4-ba9f-e7eeda50b2df'::uuid, 'choice', 'Kích thước tập tin nào sau đây là lớn nhất?', NULL, 37)
RETURNING id INTO qid;
...
BEGIN
INSERT INTO questions (exam_id, question_type, content, image_url, order_index)
VALUES ('034de6ea-9e75-4cd4-ba9f-e7eeda50b2df'::uuid, 'dragdrop', 'Bạn cần khắc phục một số vấn đề gặp phải trên máy tính và điện thoại thông minh của mình. Hãy nối cách khắc phục sự cố trong danh sách ở cột bên phải tương ứng với vấn đề mà bạn gặp phải ở cột bên trái.', NULL, 38)
RETURNING id INTO qid;
...
BEGIN
INSERT INTO questions (exam_id, question_type, content, image_url, order_index)
VALUES ('034de6ea-9e75-4cd4-ba9f-e7eeda50b2df'::uuid, 'choice', 'Hình ảnh và văn bản trên màn hình máy tính xách tay của bạn xuất hiện méo mó. Bạn cần giải quyết vấn đề này. Việc đầu tiên bạn nên làm là gì?', NULL, 39)
RETURNING id INTO qid;
