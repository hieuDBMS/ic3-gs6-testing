...
export const StudentProgressPage = () => {
  ...
  if (!student) return <div className="p-8 text-center text-red-500">Học sinh không tồn tại</div>;

  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <div className="mb-6 flex items-center">
        <Link to="/teacher/students" className="text-primary-600 hover:text-primary-800 flex items-center font-medium">
      ...
      <div className="bg-white rounded-lg shadow overflow-hidden">
        <div className="px-6 py-5 border-b border-gray-200">
          <h2 className="text-lg font-medium leading-6 text-gray-900">Chi tiết lịch sử làm bài</h2>
        </div>
        <AttemptHistoryTable studentId={studentId} />
      </div>
    </div>
  );
};
